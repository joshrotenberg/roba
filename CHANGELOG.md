...
- **Docs site**: an [mdbook](https://rust-lang.github.io/mdBook/)
  aggregating the README, `skills/`, `agents/`, and `docs/` into a
  navigable site, deployed to GitHub Pages on push to `main`
...
- **README slimmed**: the repo `README.md` is now a tight landing
  page (~150 lines) serving both GitHub visitors and the book's
  Introduction. The four heaviest sections moved into dedicated
  `docs/` pages, each of which auto-appears in the book navigation:
  `docs/permissions.md` (safe-by-default model + cross-layer
  precedence), `docs/scripting.md` (agent ABI: stdout/stderr split,
